...
\begin{figure}[ht]
    ...
    \caption{Test error results using optimal filtered with PWC and Cosine kernel, 'xpal-original' data curve from previous experiments is added for reference.}
