...
\begin{table}[ht]
\centering
\caption{Category counts of original English data.}
\input{../img/table_original_category_counts.tex}
\label{tab:og_en_data}
\end{table}

\begin{table}[ht]
\centering
\caption{Category counts of additional data.}
\input{../img/table_additional_category_counts.tex}
\label{tab:add_data}
\end{table}
