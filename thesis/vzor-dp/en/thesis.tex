...
\begin{table}[ht]
\centering
\caption{Category counts of usable given data sorted by originally given, originally given data that is English, originally given translated to English (+ English data), supplementary data, and total (all) usable data.}
