...
\begin{table}[ht]
\centering
\caption{Category counts of usable given data sorted by originally given, originally given data that is English, originally given translated to English (+ English data), and supplementary data.}
\input{../img/table_category_counts.tex}
\label{tab:en_data_counts}
\end{table}
...
\begin{table}[!ht]
    \centering
    \caption{Best LinearSVC model classification report.}
